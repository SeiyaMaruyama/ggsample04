...
//qmake
void findQuaternion(float* q, float x, float y, float z, float a) {
  float n = x * x + y * y + z * z;
...
//slerp
void interpolateSphericalLinear(float* p, const float* q, const float* r, float t) {
...
//qrot
void rotTransMat(GLfloat* m, const float* q) {
...
int GgApp::main(int argc, const char* const* argv)
{
  ...
  while (window)
  {
    ...
    //qmake
    findQuaternion(q0, 1.0f, 0.0f, 0.0f, 1.0f);
    findQuaternion(q1, 0.0f, 0.0f, 1.0f, 2.0f);
    //slerp
    interpolateSphericalLinear(qt, q0, q1, t);
    //qrot
    rotTransMat(mr, qt);
